...
def setup_optimizer_scheduler(model, optimizer_type='AdamW', scheduler_type='cosine', class_weights=None, device='cuda', max_epochs=50, logger=None):
    ...
    optimizers = {
        ...
        'AdamW': optim.AdamW(
            ...
            betas=(0.9, 0.999), 
            eps=1e-08, 
            weight_decay=0.05 # Change from 0.01 to 0.05
        ),
...
def training_model(train_loader, val_loader, test_loader, train_dataset, val_dataset, test_dataset, num_classes, device, class_names, optimizer_type='AdamW', weighting_method='ens', scheduler_type='cosine', num_epochs=50):
    ...
    best_model_path = f"C:/Users/tanan/Downloads/anchee_fyp2/customcnn_pv_fault_best2.pth"
    ...
    # ========================================================================
    # NEW SECTION: FINAL MODEL PERFORMANCE TESTING AND EVALUATION
    # ========================================================================
    print(f"\n{'='*80}")
    ...
    final_model = create_customcnn_model(num_classes).to(device)
