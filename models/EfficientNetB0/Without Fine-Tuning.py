...
def create_efficientnetb0_model(num_classes):
    """
    Create EfficientNetB0 for transfer learning with feature extraction only.
    ...
    Returns:
        torch.nn.Module: The configured EfficientNetB0 model for transfer learning.
    """
    ...
    print("EfficientNetB0: Using as fixed feature extractor - all pre-trained layers frozen")
...
def initialize_model(num_classes, device):
    ...
    model = create_efficientnetb0_model(num_classes, unfreeze_percentage=0.5)
